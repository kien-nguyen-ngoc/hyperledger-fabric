...
{
    private ILogger _logger = LoggerFactory.Create(builder =>
    {
        builder
    ...
    public HyperledgerConnector(string channelName, string chaincodeName, HyperledgerFabricPeer peer)
    {
    ...
    public IGateway? Connect()
    {
        ...
        {
            _logger.LogError("Hyperledger Fabric connect error", ex);
            return null;
        }
    }
    ...
    private GrpcChannel? CreateGrpcConnection()
    {
        ...
        {
            _logger.LogError("Hyperledger Fabric grpc channel error", ex);
            return null;
        }
    }

    private IIdentity CreateIdentity()
    {
